...
with DAG('increment_load_radar', default_args=default_args, schedule_interval='@once') as dag:

    @task_group
    def group_task_increment_load_radar_into_staging():
    ...
    @task_group
    def group_task_increment_load_radar_into_core():
        ...
        #                 "from": "pre_core",
        #                 "localField": "_id",
        #                 "foreignField": "radar_sweep_id",  # Corrected field name
        #                 "as": "matched_docs"
        #             }
        #         },
        #         {
        ...
        #         {
        #             "$project": {
        #                 "_id": 0,  # Loại bỏ _id của radar_sweep
        #                 "time_volume_start": 1,
        #                 "radar_location_id": 1
        #             }
        #         }
        ...
        def group_task_process_batch_file(key):
            ...
            #AUDIT_LOG
            writing_audit_log = task_write_audit_log_load(time_key=loading_dim_time, location_key=loading_dim_location)

            #CLEAR
            # clearing_pre_core = task_clear_pre_core()
            # task order
            result = [loading_dim_time, loading_dim_location, loading_dim_element, loading_fact_radar_sweep, loading_fact_radar] >> writing_audit_log 
    ...
    increment_loading_staging = group_task_increment_load_radar_into_staging()
    increment_loading_core = group_task_increment_load_radar_into_core()

    increment_loading_staging >> increment_loading_core
